...
public class BusinessRegisterActivity extends AppCompatActivity {
    ...
    private void sendToLogin() {
        Intent loginIntent = new Intent(BusinessRegisterActivity.this, LoginActivity.class);
        startActivity(loginIntent);
        finish();
    }

    private void sendToMain() {
        Intent registerIntent = new Intent(BusinessRegisterActivity.this, MainActivity.class);
